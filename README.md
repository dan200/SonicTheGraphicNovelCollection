...
The presentation of these graphic novels is inspired by [The Complete Judge Dredd Case Files](https://shop.2000ad.com/catalogue/graphic-novels/dredd-case-files): Stories that were originally split into multiple parts have been joined back together, spin-off stories have been carefully placed to flow seamlessly with the main strip, and unrelated articles and adverts have been removed. All in all: these novels aim to be the best possible way to read the comic stories from *Sonic the Comic*.

## How to Read

To read *Sonic the Graphic Novel collection*, you will first need to acquire copies of *Sonic the Comic*, *Sonic the Poster Mag*, *Sonic the Summer Special*, the *Sonic Holiday Special* and the *Knuckles Knock-Out Special*. These are not redistributed here, but can be found on [The Internet Archive](https://archive.org/search.php?query=%22sonic%20the%20comic%20book%20collection%22) (The spin-off comics are optional, but you'll miss out on some good stories without them). Once you have collected all your issues, do the following:
...
4. Double-click "Export.bat". You will be asked whether or not you want enhance the image quality on your comic files. This is optional, but will greatly improve the image quality of your comics. Press Y or N to choose an option
5. When the export process is complete, you will find your new graphic novels in a newly created folder called "volumes". These can now be read in a CBZ reader of your choice!
